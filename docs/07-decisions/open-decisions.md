...
| P0 | choose replication hardware after the reference builds | IH-02, SM-02-04, GW-01 | tested reference designs and owner approval | final model and quantity per station |
