...
|---|---|---|
| [MET-01](MET-01.md) | Bench integration of loaned meteorological instruments | blocked on physical model verification |
| [WX-CANDIDATE](WX-CANDIDATE.md) | Johan's proposed high-end/9-in-1 weather station | candidate only |
